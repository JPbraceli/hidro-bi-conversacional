#!/usr/bin/env python3
"""
Script para importar dumps con contraseña automática
"""
import psycopg2
import subprocess
import os

def import_dumps_with_password():
    """Importar dumps con contraseña automática"""
    try:
        ...
        os.environ['PGPASSWORD'] = 'localpass'
